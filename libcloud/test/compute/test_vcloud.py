...
class VCloud_5_1_Tests(unittest.TestCase, TestCaseMixin):
    ...
    def setUp(self):
        VCloudNodeDriver.connectionCls.host = 'test'
        VCloudNodeDriver.connectionCls.conn_classes = (
            None, VCloud_5_1_MockHttp)
        VCloud_5_1_MockHttp.type = None
...
class VCloud_5_1_MockHttp(VCloud_1_5_MockHttp, unittest.TestCase):
    fixtures_5_1 = ComputeFileFixtures('vcloud_5_1')

    def _api_vAppTemplate_vappTemplate_ac1bc027_bf8c_4050_8643_4971f691c158(self, method, url, body, headers):
        body = self.fixtures_5_1.load('api_vAppTemplate_vappTemplate_ac1bc027_bf8c_4050_8643_4971f691c158.xml')
        return httplib.OK, body, headers, httplib.responses[httplib.OK]
